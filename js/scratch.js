...
var secondFloorExplore = new Location ('You wander deeper into the dimly lit D+H headquarters, you enter the main office and there he is. Dracula and his henchmen...You have become a meal. You lose. lol')
...
var thirdFloorExplore = new Location ('Large empty shoes and wigs are strewn about the floor. The seal that was waiting in the elevator with the ball bouncing on its nose slides past you and dissapears around a corner. Clowns come arond the corner....You have become a meal. You lose. lol')
...
var fourthFloorExplore = new Location ('The hall has a strong oder that reminds you of that class fildtrip to the Phish concert that your band teacher got fired for taking you to. Two large guard dogs start to walk towards you....You have become a meal. You lose. lol')
...
var ninthFloorExplore = new Location ('This might be the home of Impact Dialing, you will never know because as soon as you step off the elevator you are sucked into a coding loop that never ends.')
...
var tenthFloorExplore = new Location ('Throx helps customers fight the infamous sock monster by selling socks in threes, not pairs. That way, when you lose one, you still got a backup sock to keep the other company, so you can keep wearing your favorite pair and doing your laundry worry free. Unfortunatly socks are always made in pairs so all of the extra socks have turned into a giant ball that roams the halls, you are crushed by the sock moster.')
