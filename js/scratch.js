...
var guardAnswer = new PuzzleMessage("the guard looks at you with meagre respect in his eyes and slips an IDCARD into your wallet. 'Good job kid, you passed the first test, now you can ENTER the elevator.'")
 ...
 var clownAnser = new PuzzleMessage("the clown is very impressed and hands you the pen, turns and saunters off in true Charlie Chaplin style, ENTER the elevator")
 ...
 var fourthFloorExplore = new Location ('fourthFloorExplore', 'The hall has a strong oder that reminds you of that class fieldtrip to the Phish concert that your band teacher got fired for taking you to. Two large guard dogs start to walk towards you and unspeakable horrors are acted out, ENTER to elevator');
 ...
 var eighthFloorExplore = new Location ('eighthFloorExplore', 'Two large glass doors are at the end of the hallway, through the glass you see a few people sitting on couches with laptops who look to relaxed to be getting paid. (ENTER office or ENTER the elevator)');
 ...
 var tenthFloorExplore = new Location ('tenthFloorExplore', 'Throx helps customers fight the infamous sock monster by selling socks in threes, not pairs. That way, when you lose one, you still got a backup sock to keep the other company, so you can keep wearing your favorite pair and doing your laundry worry free. Unfortunatly socks are always made in pairs so all of the extra socks have turned into a giant ball that roams the halls, you are knocked silly by the sock moster, ENTER the elevator');
  ...
  if (input === "floor 8" && player.inventory[0] === "idCard"){
      ...
      $("input#commandBox").val("");
        ...
        $("input#commandBox").val("");
          ...
          inputCmd.value = elevenththFloorExplore.name + ": " + elevenththFloorExplore.description;
          $("input#commandBox").val("");
...
// var clown = new Location('clown', "The tall Filipino woman dressed as a clown says'You can have my space pen, yes it rights even when it is upside down, if you can tell me how to minimize the front window to the doc using this keyboard.'")
// var clownAnser = new PuzzleMessage("the clown is very impressed and hands you the pen, turns and saunters off in true Charlie Chaplin style.")
//
// if (inputted === "talk to clown") {
//   inputCmd.value = clown.name + ": " + clown.description;
//   $("input#commandBox").val("");
//
//   $("#inputCommands").submit(function(event) {
...
// var farmerAnswer = new PuzzleMessage("the farmer chuckles and says why are you telling me command functions and hands you the bike lock.")
//
// if (inputted === "talk to farmer") {
...
// var managerAnswer = new PuzzleMessage("Wow, now I can write about missing socks till I die, die happy, here is an empty notebook, I hope it helps you on your coding journey.")
//
// if (inputted === "talk to manager") {
...
// var SuzanneAnswer = new PuzzleMessage("Thank you, now I can roam the streets hunting my next fantasy date, take this bike, and create a fantasy date of your own.")
//
// if (inputted === "talk to suzanne") {
